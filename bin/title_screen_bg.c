...
static const Vtx title_screen_bg_vertex_0A000000[] = {
    {{{     0,     192,     -1}, 0, {     0,    608}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    320,     192,     -1}, 0, {  2528,    608}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    320,     256,     -1}, 0, {  2528,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,     256,     -1}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,     128,     -1}, 0, {     0,    608}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    320,     128,     -1}, 0, {  2528,    608}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    320,     192,     -1}, 0, {  2528,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,     192,     -1}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,     64,     -1}, 0, {     0,    608}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    320,     64,     -1}, 0, {  2528,    608}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    320,     128,     -1}, 0, {  2528,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,     128,     -1}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,      0,     -1}, 0, {     0,    608}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    320,      0,     -1}, 0, {  2528,    608}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    320,     64,     -1}, 0, {  2528,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{     0,     64,     -1}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
};
...
#include "textures/title_screen_bg/title_screen_bg.001C0.ia16.inc.c"
};

// 0x0A000E40
ALIGNED8 static const Texture title_texture_0A000E40[] = {
#include "textures/title_screen_bg/title_screen_bg.00E40.ia16.inc.c"
};

// 0x0A001AC0
ALIGNED8 static const Texture title_texture_0A001AC0[] = {
#include "textures/title_screen_bg/title_screen_bg.01AC0.ia16.inc.c"
};

// 0x0A002740
ALIGNED8 static const Texture title_texture_0A002740[] = {
#include "textures/title_screen_bg/title_screen_bg.02740.ia16.inc.c"
};

// 0x0A0033C0
ALIGNED8 static const Texture title_texture_0A0033C0[] = {
#include "textures/title_screen_bg/title_screen_bg.033C0.ia16.inc.c"
};

// 0x0A004040
ALIGNED8 static const Texture title_texture_0A004040[] = {
#include "textures/title_screen_bg/title_screen_bg.04040.ia16.inc.c"
};

// 0x0A004CC0
ALIGNED8 static const Texture title_texture_0A004CC0[] = {
#include "textures/title_screen_bg/title_screen_bg.04CC0.ia16.inc.c"
};

// 0x0A005940
ALIGNED8 static const Texture title_texture_0A005940[] = {
#include "textures/title_screen_bg/title_screen_bg.05940.ia16.inc.c"
};
...
#include "textures/title_screen_bg/title_screen_bg.06648.ia16.inc.c"
};
