...
#define SOUND_ACTION_UNK54                       /* 0x04549080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x54, 0x90, 0) // unverified, unused
...
#define SOUND_OBJ_HOPPER_WALK                    /* 0x50200080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x20, 0x00, SOUND_DISCRETE)
...
#define SOUND_OBJ_HOPPER_ALERT                   /* 0x502F0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x2F, 0x00, SOUND_DISCRETE)
...
#define SOUND_AIR_UNK07                          /* 0x60070000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x07, 0x00, 0) // Spindrift move sound, broken in final.
