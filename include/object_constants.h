...
/* Hopper triplet spawner */
    /* oBehParams2ndByte */
    #define HOPPER_TRIPLET_SPAWNER_BP_SIZE_MASK 0x00000003
    #define HOPPER_TRIPLET_SPAWNER_BP_EXTRA_HOPPERS_MASK 0x000000FC
    /* oAction */
    #define HOPPER_TRIPLET_SPAWNER_ACT_UNLOADED 0
    #define HOPPER_TRIPLET_SPAWNER_ACT_LOADED 1

/* Hopper */
    /* oBehParams2ndByte */
    #define HOPPER_BP_SIZE_MASK 0x00000003
    #define HOPPER_SIZE_REGULAR 0
    #define HOPPER_SIZE_HUGE 1
    #define HOPPER_SIZE_TINY 2
    #define HOPPER_BP_TRIPLET_FLAG_MASK 0x000000FC
    /* oAction */
    #define HOPPER_ACT_WALK 0
    #define HOPPER_ACT_ATTACKED_MARIO 1
    #define HOPPER_ACT_JUMP 2
