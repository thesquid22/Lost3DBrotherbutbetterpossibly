...
#define ACT_CRYING                     0x0C40020C // (0x00C | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define ACT_CHARGE               (0x058 | ACT_FLAG_MOVING | ACT_FLAG_ATTACKING | ACT_FLAG_INVULNERABLE)
...
#define ACT_FAST_LONG_JUMP_LAND        (0x07B | ACT_FLAG_MOVING)
...
#define ACT_SQUAT_KICKING              0x018008A5 // (0x0A5 | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
#define ACT_SPAWN_SPIN_AIRBORNE_SNOW   0x0000193E // (0x124 | ACT_FLAG_AIR | ACT_FLAG_INTANGIBLE)
...
#define ACT_START_SWINGING             (0x174 | ACT_FLAG_STATIONARY | ACT_FLAG_HANGING | ACT_FLAG_PAUSE_EXIT)
#define ACT_SWINGING                   (0x175 | ACT_FLAG_STATIONARY | ACT_FLAG_HANGING)
