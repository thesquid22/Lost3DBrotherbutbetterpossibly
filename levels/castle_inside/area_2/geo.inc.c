...
const GeoLayout castle_inside_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 0, -1, 0, 90, 0, 0, castle_inside_dl_Pre1st_Floor_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, castle_inside_dl_Pre1st_Floor_mesh_layer_4),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, castle_inside_dl_Pre1st_Floor_mesh_layer_5),
		GEO_CLOSE_NODE(),
