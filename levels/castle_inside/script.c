...
const LevelScript level_castle_inside_entry[] = {
    ...
    PAINTING_WARP_NODE(/*id*/ 0x05, /*destLevel*/ LEVEL_HMC, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
		...
		//CCM
		OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1730, -527,  1029, /*angle*/ 0,   90, 0, /*behParam*/ 0x00380000, /*beh*/ bhvPaintingStarCollectWarp),
		WARP_NODE(/*id*/ 0x38, /*destLevel*/ LEVEL_CASTLE, /*destArea*/ 0x02, /*destNode*/ 0x38, /*flags*/ WARP_NO_CHECKPOINT),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/    1730, -527,  1029, /*angle*/ 0,   90, 0, /*behParam*/ 0x00680000, /*beh*/ bhvPaintingDeathWarp),
