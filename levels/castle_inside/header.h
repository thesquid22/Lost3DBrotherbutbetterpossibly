...
// geo
extern const GeoLayout castle_geo_blue_star_door[];
extern const GeoLayout castle_geo_red_star_door[];
extern const GeoLayout castle_geo_green_star_door[];
...
extern const Gfx inside_castle_seg7_dl_0703BFA8[]; //BLUE MAIN
extern const Gfx inside_castle_seg7_dl_red_main[]; //RED MAIN
extern const Gfx inside_castle_seg7_dl_green_main[]; //GREEN MAIN
