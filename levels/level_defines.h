...
DEFINE_LEVEL("CASTLE", LEVEL_STAGE1, COURSE_NONE, castle, generic, 15000, 0x08, 0x08, 0x08, _, _) 
DEFINE_LEVEL("ATHLETIC", LEVEL_ATHLETIC, COURSE_NONE, athletic, generic, 15000, 0x08, 0x08, 0x08, _, _) 
...
DEFINE_LEVEL("SELECT ROOM", LEVEL_CASTLE, COURSE_NONE, castle_inside, inside, 28000, 0x28, 0x20, 0x00, _, sCamCastle) 
...
DEFINE_LEVEL("YAJIMA TEST", LEVEL_YAJIMA_TEST, COURSE_NONE, yajima_test, generic, 15000, 0x20, 0x70, 0x70, _, _) 
...
STUB_LEVEL("SAND", LEVEL_UNKNOWN_38, COURSE_NONE, 20000, 0x00, 0x00, 0x00, sDynUnk38, _) 
