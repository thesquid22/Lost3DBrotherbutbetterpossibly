...
const LevelScript level_main_scripts_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_STAR2,            star2_geo),
    FREE_LEVEL_POOL(),
...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_KOOPA_SHELL,             koopa_shell_old_geo),
...
const LevelScript script_func_global_4[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_WATER_MINE,              ground_mine_geo), //Landmine
    RETURN(),
};
...
const LevelScript script_func_global_11[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_PEACH,                   RCP_HmsEnemypeach_basic_skelton),
