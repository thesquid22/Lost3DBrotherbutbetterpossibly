...
const GeoLayout hmc_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, hmc_dl_CaveDungeon_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, hmc_dl_CaveDungeon_mesh_layer_5),
			GEO_DISPLAY_LIST(LAYER_ALPHA, hmc_dl_CaveDungeon_mesh_layer_4),
		GEO_CLOSE_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT, 90, 0, 0, hmc_dl_Flame_mesh_layer_5),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, hmc_dl_Poles_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
