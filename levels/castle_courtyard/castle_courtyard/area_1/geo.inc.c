...
const GeoLayout castle_courtyard_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_courtyard_dl_MAP_mesh),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, castle_courtyard_dl_other_wall_mesh),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, castle_courtyard_dl_shadows_mesh),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_courtyard_dl_windows_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
