...
const GeoLayout castle_courtyard_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(1, castle_courtyard_dl_Area1_mesh_layer_1),
		GEO_DISPLAY_LIST(5, castle_courtyard_dl_Area1_mesh_layer_5),
		GEO_DISPLAY_LIST(5, castle_courtyard_dl_lights_mesh_layer_5),
		GEO_DISPLAY_LIST(5, castle_courtyard_dl_shadows_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout castle_courtyard_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
	            GEO_BACKGROUND(BACKGROUND_CREEPY, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
