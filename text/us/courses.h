COURSE_ACTS(COURSE_BOB, _(" 1 SKY HIGH FORTRESS"),
       _("FOUR PESKY PLANTS")     , _("PRECISE JUMP TO THE FORTRESS") , _("WHAT'S IN THE FLYING ISLAND?"),
       _("8 RED COINS SCATTERED OVER THE FORTRESS")          , _("CROSSING THE SMALL BRIDGE")        , _("WHO IS ON TOP?"))
...
COURSE_ACTS(COURSE_JRB, _(" 3 AQUATIC TRENCH"),
       _("THE SUBMARINE'S TREASURE")    , _("SINISTER GUEST IN THE TRENCH") , _("TREASURE OF THE DEEP"),
       _("DEEP DIVE FOR RED COINS")  , _("A RAY OF FUN")     , _("A MYSTERIOUS BOX"))

COURSE_ACTS(COURSE_CCM, _(" 4 BURNT-CACKLES CAVE"),
       _("DON'T DISTURB THE MAGMATIC DINOSAUR!")             , _("LI'L PENGUIN LOST")             , _("WHAT'S IN THE STONE WALL?"),
       _("FREEZY BATTLE")  , _("RED COINS IN THE SNOW")       , _("WALL KICKS WILL WORK"))
...
COURSE_ACTS(COURSE_BBH, _(" 5 BIG BOO'S HAUNT"),
       ...
       _("SEEK THE 8 RED COINS")          , _("THE DEAD COME BACK TO LIFE!")             , _("SINISTER REMNANTS BELOW"))

COURSE_ACTS(COURSE_HMC, _(" 4 FLAMING CATACOMBS"),
       _("TREASURE OF THE MAGMA DRAGON")  , _("SNIFIT'S MAZE RIDE")       , _("LAVAWAY OF THE CAVERNS"),
       _("CURSED GRAVES OF THE UNKNOWN")       , _("8 COINS IN THE CAVE")             , _("WATCHED FROM AFAR"))
