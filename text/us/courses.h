COURSE_ACTS(COURSE_BOB, _(" 1 SKY HIGH FORTRESS"),
       _("HUNGRY CARNIVOROUS PLANTS")     , _("PRECISE JUMP TO THE FORTRESS") , _("WHAT'S IN THE FLYING ISLAND?"),
...
COURSE_ACTS(COURSE_HMC, _(" 6 FLAMING CATACOMBS"),
       _("DON'T DISTURB THE MAGMATIC DINOSAUR!")  , _("ELEVATE FOR 8 RED COINS")       , _("METAL-HEAD MARIO CAN MOVE!"),
