...
extern const Gfx RCP_newrabbit_base0[];
extern const Gfx RCP_newrabbit_base1[];
extern const Gfx RCP_newrabbit_base2[];
extern const Gfx RCP_newrabbit_base3[];
extern const Gfx RCP_newrabbit_base4[];
extern const Gfx RCP_newrabbit_base5[];
extern const Gfx RCP_newrabbit_base6[];
extern const Gfx RCP_newrabbit_base7[];
extern const Gfx RCP_newrabbit_base8[];
extern const Gfx RCP_newrabbit_base9[];
extern const Gfx RCP_newrabbit_base10[];
extern const Gfx RCP_newrabbit_base11[];
